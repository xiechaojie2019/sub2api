export default {
  ...
  usage: {
    ...
    detail: {
      action: '详情',
      actionTitle: '查看入参与返回结果',
      title: '使用记录详情',
      time: '时间', model: '模型', endpoint: '端点',
      stream: '流式', streamOn: '是', streamOff: '否',
      tokens: 'Tokens', cost: '费用',
      requestBody: '请求入参',
      responseBody: '返回结果',
      copy: '复制', copied: '已复制',
      truncated: '已截断',
      notCaptured: '未记录该条请求的请求/响应体（捕获开关未开启，或请求发生在开启之前）',
      captureHint: '内容按系统设置的捕获上限截断；流式响应保存的是响应流开头的原始分片。',
