export default {
  ...
  usage: {
    ...
    detail: {
      action: 'Details',
      actionTitle: 'View request and response payload',
      title: 'Usage Record Details',
      time: 'Time', model: 'Model', endpoint: 'Endpoint',
      stream: 'Stream', streamOn: 'Yes', streamOff: 'No',
      tokens: 'Tokens', cost: 'Cost',
      requestBody: 'Request Payload',
      responseBody: 'Response Payload',
      copy: 'Copy', copied: 'Copied',
      truncated: 'Truncated',
      notCaptured: 'Request/response payload was not recorded for this request (capture disabled, or the request predates it)',
      captureHint: 'Content is truncated according to the capture limit configured in system settings; streaming responses keep the raw leading chunks of the stream.',
      loadFailed: 'Failed to load details. Please try again later.',
    },
